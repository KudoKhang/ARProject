...
//  ARProject
//
//  Created by Nghĩa Khang on 05/12/2022.
//
...
struct ContentView : View {
    ...
    @State private var selectdModel: Model?
    ...
    var body: some View{
        ZStack(alignment: .bottom){
            ...
            if self.isPlacementEnabled{
                PlacementButtonView(isPlacementEnable: self.$isPlacementEnabled,
                                    selectedModel: self.$selectdModel,
            ...
            HStack(spacing: 20){
                ForEach(0 ..< self.models.count){
                    index in Button(action: {
                        print("DEBUG: selececd model with name: \(self.models[index].modelName)")
